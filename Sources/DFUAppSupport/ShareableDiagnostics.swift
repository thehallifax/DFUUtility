...
public enum ShareableDiagnostics {
    ...
    private static func updateDescription(_ state: AppUpdateState) -> String {
        ...
        case .binaryAvailable: "Healthy; binary update available"
        case .downloading: "Downloading update"
        case .verifying: "Verifying update"
        case .verifiedReady: "Verified update ready to install"
        case .blockedByOperation: "Blocked by active operation"
