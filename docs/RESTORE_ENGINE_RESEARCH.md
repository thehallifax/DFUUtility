...
The initial spike had no target. Subsequent integration testing used a MacBook Air M2 (`Mac14,2`, ECID `0xTESTECID00000001`) and is recorded below. No destructive restore has been performed.
...
Hardware: MacBook Air M2, model `Mac14,2`, ECID `0xTESTECID00000001`, connected to the Apple Silicon host through the applicable DFU USB-C path.
